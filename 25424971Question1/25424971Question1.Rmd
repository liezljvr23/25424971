...
#### Plot 1 
Average price and rating by country. Australia and England are clear outliers. Although roasters in these countries have, on average, the highest ratings, all the countries recieve a n averge rating of 90 or above. I would suggest that the prices disqualify the further inclusion of Australian and English roasters.
...
g <-
    plot_rating_vs_price(data = coffee_filtered, group_var = loc_country, title = "Average Rating and Price by Location of Roaster without Outliers")
...
#### 4
Now for completedness, I'll use my plot function to get an idea of what I am looking at. This plot indicates that coffee brands that have reviews describing the aroma and chocolatiness of the coffee are the best deal when it comes to the ratings-price relationship. Subsequent analysis will be focused on these observations.
...
```
#### Plot 5
The goal is to trim the most expensive. Boxplot shows outliers in red.
...
#### Plot 6 tile
This plot depicts the average ratings by roaster and roast level.
