...
#### Plot 4
```{r, warning =  FALSE, fig.align = 'center', fig.cap = "Happiness Ladder.\\label{Figure1}", fig.ext = 'png'}
m <- plot_score_scatter(movies,
                   x_var     = imdb_score,
                   y_var     = tmdb_score,
                   size_var  = runtime,
                   label_var = primary_genre,
                   title     = "Average IMDb vs TMDB Score by Genre",
                   x_axis    = "Avg IMDb Score",
                   y_axis    = "Avg TMDB Score")
m
```
